    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="category_article_body">
                            <div class="top_article_img">
                                <img class="img-responsive" src="{{ asset('img/category_img7.jpg') }}"
                                    alt="feature-top">
                            </div>
                            <!-- top_article_img -->
                    ...
                    <div class="col-md-6">
                        <div class="category_article_body">
                            <div class="top_article_img">
                                <img class="img-responsive" src="{{ asset('img/category_img8.jpg') }}"
                                    alt="feature-top">
                            </div>
                            <!-- top_article_img -->
            ...
            <div class="col-md-4">
                ...
                <div class="widget hidden-xs m30">
                    <img class="img-responsive widget_img" src="{{ asset('img/podcast.jpg') }}assets/" alt="add_one">
                </div>
                <!--Advertisement-->
            </div>
            <!-- col-md-4 -->
