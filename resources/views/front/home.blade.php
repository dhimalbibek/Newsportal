            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="feature_static_wrapper">
                        <div class="feature_article_img">
                            <img class="img-responsive" src="{{ asset('img/feature-top.jpg') }}" alt="feature-top">
                        </div>
                        <!-- feature_article_img -->
            ...
            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="top_article_img">
                                        <a href="single.html" target="_self"><img class="img-responsive"
                                                src="{{ asset('img/feature-top.jpg') }}" alt="feature-top">
                                        </a>
                                    </div>
                                    <!----top_article_img------>
                                </div>
                                    ...
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <a href="single.html" target="_self">
                                                <img class="img-responsive" src="{{ asset('img/feature-top.jpg') }}"
                                                    alt="feature-top">
                                            </a>
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <a href="single.html" target="_self">
                                                <img class="img-responsive" src="{{ asset('img/gad_top1.jpg') }}"
                                                    alt="feature-top">
                                            </a>
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <a href="single.html" target="_self">
                                                <img class="img-responsive" src="{{ asset('img/design_top1.jpg') }}"
                                                    alt="feature-top">
                                            </a>
                                        </div>
                                        <!-- top_article_img -->
                                ...
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <a href="single.html" target="_self">
                                                <img class="img-responsive" src="{{ asset('img/design_top2.jpg') }}"
                                                    alt="feature-top">
                                            </a>
                                        </div>
                                        <!-- top_article_img -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="category_article_body">
                                        <div class="top_article_img">
                                            <a href="single.html" target="_self">
                                                <img class="img-responsive" src="{{ asset('img/design_top3.jpg') }}"
                                                    alt="feature-top">
                                            </a>
                                        </div>
                                        <!-- top_article_img -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="widget hidden-xs m30">
                        <img class="img-responsive adv_img" src="{{ asset('img/cat-mobi-sm1.jpg') }}" alt="add_one">
                        <img class="img-responsive adv_img" src="{{ asset('img/cat-mobi-sm1.jpg') }}" alt="add_one">
                        <img class="img-responsive adv_img" src="{{ asset('img/cat-mobi-sm1.jpg') }}" alt="add_one">
                        <img class="img-responsive adv_img" src="{{ asset('img/cat-mobi-sm1.jpg') }}" alt="add_one">
                    </div>
                    ...
                    <div class="widget hidden-xs m30">
                        <img class="img-responsive widget_img" src="{{ asset('img/cat-mobi-sm2.jpg') }}" alt="add_one">
                    </div>
                    <!-- Advertisement -->
                    ...
                    <div class="widget m30">
                        ...
                        <div class="widget_body"><img class="img-responsive left"
                                src="{{ asset('img/editor_pic1.jpg') }}" alt="Generic placeholder image">
                    ...
                    <div class="widget hidden-xs m30">
                        <img class="img-responsive add_img" src="{{ asset('img/editor_pic2.jpg') }}" alt="add_one">
                        <img class="img-responsive add_img" src="{{ asset('img/editor_pic2.jpg') }}" alt="add_one">
                        <img class="img-responsive add_img" src="{{ asset('img/editor_pic2.jpg') }}" alt="add_one">
                        <img class="img-responsive add_img" src="{{ asset('img/editor_pic2.jpg') }}" alt="add_one">
                    </div>
                    ...
                    <div class="widget m30">
                        ...
                        <div class="widget_body"><img class="img-responsive left"
                                src="{{ asset('img/editor_pic3.jpg') }}" alt="Generic placeholder image">
