            ...
            <div class="col-md-3">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('img/tech_photo2.jpg') }}"
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('img/tech_photo4.jpg') }}"
                                alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('img/tech_photo3.jpg') }}"
                                alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
